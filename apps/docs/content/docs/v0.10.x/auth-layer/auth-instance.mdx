...
The auth instance is a core concept in Better Auth that provides all the authentication functionality. In @b3nab/payload-better-auth, we create a typed wrapper around this instance to ensure type safety and seamless integration with Payload CMS.
